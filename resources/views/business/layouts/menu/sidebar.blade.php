        ...
        <div class="app-navbar flex-column flex-center py-4">
            ...
            <a href="pages/user-profile/overview.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-2.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="account/billing.html" class="btn btn-icon btn-default mx-auto mb-4 active">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-7.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="account/activity.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-10.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="account/overview.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-1.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="account/settings.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-3.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="apps/projects/users.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-21.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="apps/projects/targets.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-6.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="apps/projects/files.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-13.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
            <!--begin::Navbar item-->
            <a href="apps/user-management/users/list.html" class="btn btn-icon btn-default mx-auto mb-4 ">
                <div class="symbol symbol-40px">
                    <img src="/business_admin/assets/media/avatars/300-20.jpg" class="" alt="">
                </div>
            </a>
            <!--end::Navbar item-->
