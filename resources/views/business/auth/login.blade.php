            ...
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
                ...
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    ...
                    <div class="d-flex flex-center flex-column flex-column-fluid pb-15 pb-lg-20">
                        ...
                        <!--begin::Form-->
                        <form class="form w-100" method="post" novalidate="novalidate" id="kt_sign_in_form" action="{{route('business.login')}}">
                            <!--begin::Heading-->
                            @csrf
                            ...
                            <div class="separator separator-content my-14">
                                <span class="w-250px text-gray-500 fw-semibold fs-7">@lang('profile.loginHrText')</span>
                            </div>
                            <!--end::Separator-->
                            ...
                            <div class="fv-row mb-3">
                                <!--begin::Password-->
                                <input type="password" placeholder="@lang('profile.password')" name="password" autocomplete="off" class="form-control bg-transparent">
                                <!--end::Password-->
                            </div>
                            <!--end::Input group--->
                            ...
                            <div class="d-grid mb-10">
                                <button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
                                    ...
                                    <span class="indicator-label">@lang('profile.login')</span>
                                    <!--end::Indicator label-->
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">
                               @lang('profile.noRegister')

                                <a href="{{route('business.register')}}" class="link-primary">
                                    @lang('profile.newRegister')
                                </a>
                            </div>
                            <!--end::Sign up-->
                        </form>
