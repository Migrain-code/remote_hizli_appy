...
var KTSigninTwoFactor = function () {
    ...
    return {
        init: function () {
            ...
            t = document.querySelector("#kt_sing_in_two_factor_form"), (e = document.querySelector("#kt_sing_in_two_factor_submit")).addEventListener("click", (function (n) {
                ...
                o.map((function (t) {
                    ...
                    e.removeAttribute("data-kt-indicator"), e.disabled = !1,
                        $('#kt_sing_in_two_factor_form').submit();
                }), 1e3)) : swal.fire({
            ...
            var inputFields = [].slice.call(t.querySelectorAll('input[maxlength="1"]'));
            ...
            var clearButton = document.querySelector("#clear_button"); // Temizle düğmesinin id'sini kullanın
